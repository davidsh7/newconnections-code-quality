...
const noEmptyMocks = {
        ...
        return {
            ...
            VariableDeclarator(node) {
                ...
                if (node.init?.type === "CallExpression" &&
                    ...
                    viFnVariables.set(node.id.name, node);
                }
            },
        };
    },
    meta: {
        docs: {
            ...
            description: "Evita mocks vacíos sin `.mockResolvedValue()` o `.mockReturnValue()`.",
            recommended: true,
        },
        messages: {
            missingResolvedValue: "El mock de Vitest (`vi.fn()`) en un servicio asíncrono debe usar `.mockResolvedValue()` o `.mockReturnValue()`.",
        },
        schema: [],
        type: "problem",
    },
...
//# sourceMappingURL=noEmptyMocks.js.map